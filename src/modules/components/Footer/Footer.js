...
import { fetchCompanyProfile } from 'reduxModule/common';
...
class Footer extends React.PureComponent {
  ...
  render = () => {
    const { info = {}, intl: { formatMessage } } = this.props;
    return (
...
export default injectIntl(connect(mapState, { fetchCompanyProfile })(Footer))